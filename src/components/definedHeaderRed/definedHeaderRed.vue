<template>
	<div>
		<div class="dialog_center">
			...
			<div class="flex top_info">
				...
				<div class="flex">
					<draggable class="flex draggable_pic" v-model="headerDataTemp.pic" :options="{group:'pic'}" @start="drag=true" @end="drag=false">
						<div class="pic_item" v-for="item of headerDataTemp.pic" :key="item.id" :title="picTitle[item.id]" @mouseleave.prevent="handleMouseLeavePic($event)" @mouseenter.prevent="handleMouseEnterPic($event)">
			...
			<div class="set_qq">
				<span>设置客服QQ：</span>
				<input ref="qq" v-model="headerDataTemp.qq.num || 2289318986" type="text" name="" id="" value="" />
...
<style scoped>
	@import url("./definedHeaderRed.css");
</style>
